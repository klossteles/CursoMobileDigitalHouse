package com.klossteles.desafioandroid.register.view
...
class RegisterFragment : Fragment() {
    ...
    private fun checkRepeatPassword(view: View, password: String, success: Boolean): Boolean {
        var isOk = success
        val repeatPassword =
            view.findViewById<TextInputEditText>(R.id.edtRepeatPasswordRegister)?.text.toString()

        if (repeatPassword.isEmpty()) {
            view.findViewById<TextInputLayout>(R.id.txtRepeatPasswordRegister).error =
                getString(R.string.password_cannot_be_null)
            isOk = false
            ...
            view.findViewById<TextInputLayout>(R.id.txtRepeatPasswordRegister).error = getString(
    ...
    private fun checkRepeatPasswordChanged(view: View) {
        view.findViewById<TextInputEditText>(R.id.edtRepeatPasswordRegister)
            .addTextChangedListener(object :
                TextWatcher {
                override fun afterTextChanged(s: Editable?) { }
                ...
                override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                    view.findViewById<TextInputLayout>(R.id.txtRepeatPasswordRegister).error = ""
                    val password = view.findViewById<TextInputEditText>(R.id.edtPasswordRegister)?.text.toString()
                    checkRepeatPassword(view, password, true)
                }
            })
    }
}